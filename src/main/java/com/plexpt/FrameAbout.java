...
public class FrameAbout extends JInternalFrame {
    ...
    JLabel jLabelLogo;
    JLabel jLabelHeader =
            new JLabel("<html><h3>" + PROP.getProperty("app.artifactId") + "-" + PROP.getProperty("app.version") + "</h3></html>");
    ...
    public FrameAbout() {
        ...
        //ImageIcon resizedIcon = new ImageIcon(new ImageIcon(getClass().getClassLoader()
        // .getResource("images/logo.png")).getImage().getScaledInstance(200, 50, Image
        // .SCALE_DEFAULT));
